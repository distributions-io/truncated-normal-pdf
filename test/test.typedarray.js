...
describe( 'typed-array pdf', function tests() {
	...
	it( 'should evaluate the truncated normal pdf', function test() {
		var data, actual, expected, i;

		data = new Float64Array( validationData.data );
		actual = new Float64Array( data.length );

		actual = pdf( actual, data, a, b, mu, sigma );
	...
	it( 'should return an empty array if provided an empty array', function test() {
		assert.deepEqual( pdf( new Int8Array(), new Int8Array(), a, b, mu, sigma ), new Int8Array() );
	});
